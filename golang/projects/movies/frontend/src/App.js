...
import GenrePageFunc from "./components/GenrePageFunc";
...
export default class App extends Component {
    ...
    componentDidMount() {
        ...
        if (t) {
            if (this.state.jwt === "") {
                console.log("restoring jwt from App.js")
                    ...
                    <div className="row">
                        ...
                        <div className="col-md-10">
                            <Switch>
                                ...
                                <Route path="/genre/:id" component={GenrePageFunc}/>
                                ...
                                <Route exact path="/login"
                                       component={(props) => (
                                           <Login {...props} handleJWTToken={this.handleJWTChange}/>
                                       )}
                                />
