...
//go:generate mockgen -package mocks -destination mocks/mocks_api.go github.com/enesanbar/workspace/projects/linkrus/pkg/dbspgraph/proto JobQueue_JobStreamServer
