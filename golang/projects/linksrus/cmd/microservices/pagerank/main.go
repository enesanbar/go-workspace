...
import (
	...
	"github.com/enesanbar/workspace/projects/linkrus/internal/apis/linkgraphapi"
	linkgraphproto "github.com/enesanbar/workspace/projects/linkrus/internal/apis/linkgraphapi/proto"
	"github.com/enesanbar/workspace/projects/linkrus/internal/apis/textindexerapi"
	textindexerproto "github.com/enesanbar/workspace/projects/linkrus/internal/apis/textindexerapi/proto"
...
func runMain(appCtx *cli.Context) error {
	...
	case "master":
		if serviceRunner, err = pagerank.NewMasterNode(pagerank.MasterConfig{
	...
	case "worker":
		...
		if serviceRunner, err = pagerank.NewWorkerNode(pagerank.WorkerConfig{
