...
def test_get(mock_use_case, client):
    ...
    http_response = client.get_product_by_id("/rooms")
    ...
    assert http_response.mimetype == "rest/json"
...
def test_get_with_filters(mock_use_case, client):
    ...
    http_response = client.get_product_by_id(
...
def test_get_response_failures(
    ...
    http_response = client.get_product_by_id("/rooms?dummy_request_string")
